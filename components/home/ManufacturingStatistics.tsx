...
function AnimatedCounter({ end, duration = 2000, suffix = "" }: { end: number; duration?: number; suffix?: string }) {
  ...
  return (
    <div ref={ref} className="text-5xl font-bold text-[#FF6B35] sm:text-6xl lg:text-7xl">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted">
            State-of-the-art manufacturing facility with vertically integrated production lines
          </p>
        </motion.div>
        ...
        <div className="mt-16 grid grid-cols-2 gap-8 lg:grid-cols-4">
          {[
            ...
            >
              ...
              <p className="mt-2 text-lg font-semibold text-primary">{stat.label}</p>
        ...
        <motion.div
          ...
          className="mt-16 rounded-2xl bg-gradient-to-r from-[#0A1628] to-[#1E3A5F] p-8 text-white sm:p-12"
        >
          <div className="grid gap-8 lg:grid-cols-3">
            <div className="text-center">
              <div className="text-4xl font-bold text-[#FF6B35] sm:text-5xl">7</div>
              <p className="mt-2 text-lg font-medium">Production Lines</p>
              <p className="mt-1 text-sm text-gray-400">Vertically integrated manufacturing</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-[#FF6B35] sm:text-5xl">30 Days</div>
              <p className="mt-2 text-lg font-medium">OEM Delivery</p>
              <p className="mt-1 text-sm text-gray-400">Lead time guarantee</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-[#FF6B35] sm:text-5xl">40+</div>
              <p className="mt-2 text-lg font-medium">Export Countries</p>
