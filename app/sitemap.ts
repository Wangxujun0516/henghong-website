...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const pages = [
    ...
    { url: "https://www.henghongrv.com/oem-manufacturer", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "https://www.henghongrv.com/electric-vs-hydraulic", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "https://www.henghongrv.com/how-to-choose-leveling-system", priority: 0.7, changeFrequency: "monthly" as const },
